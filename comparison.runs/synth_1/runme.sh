...
HD_PWD='L:/lidar/PPJ/comparison/comparison.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log com_1010_1010.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source com_1010_1010.tcl
